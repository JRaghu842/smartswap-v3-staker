...
import UniswapV3Pool from 'smartswap-v3-core/artifacts/contracts/UniswapV3Pool.sol/UniswapV3Pool.json'
import UniswapV3FactoryJson from 'smartswap-v3-core/artifacts/contracts/UniswapV3Factory.sol/UniswapV3Factory.json'
import NFTDescriptorJson from 'smartswap-v3-periphery/artifacts/contracts/libraries/NFTDescriptor.sol/NFTDescriptor.json'
import NonfungiblePositionManagerJson from 'smartswap-v3-periphery/artifacts/contracts/NonfungiblePositionManager.sol/NonfungiblePositionManager.json'
import NonfungibleTokenPositionDescriptor from 'smartswap-v3-periphery/artifacts/contracts/NonfungibleTokenPositionDescriptor.sol/NonfungibleTokenPositionDescriptor.json'
import SwapRouter from 'smartswap-v3-periphery/artifacts/contracts/SwapRouter.sol/SwapRouter.json'
